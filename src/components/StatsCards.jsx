...
const StatsCards = () => {
  return (
    <div className="grid grid-cols-1 w-full max-w-7xl mx-auto sm:grid-cols-2 md:grid-cols-4 gap-4 p-6">
      <div className="flex flex-col items-center justify-center bg-[#FAF3ED] rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
