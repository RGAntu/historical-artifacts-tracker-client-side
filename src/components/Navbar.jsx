    ...
    <div className="navbar  shadow-sm max-w-7xl mx-auto">
      <div className="navbar-start">
        <div className="dropdown text-white">
          ...
          <ul tabIndex={0} className="menu text-secondary menu-sm dropdown-content bg-base-100  rounded-box z-10 mt-3 w-52 p-2 shadow">
            {links}
          </ul>
        </div>
      ...
      <div className="navbar-end">
        {!user ? (
          <Link to="/login" className="btn bg-primary border-0 text-white">Login</Link>
        ) : (
